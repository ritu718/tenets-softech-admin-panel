...
export default function KonfigurationMeterFirst({ text,
       ...
       <Paper variant="outlined" sx={{ p: 2, borderRadius: 2 }}>
                       ...
                       <Stack direction={{ xs: "column", sm: "row" }} spacing={1.5}>
                         <TextField
                           ...
                           value={activeFreight?.bulkyCbm || ""}
                           onChange={(e) => handleFreightChange("bulkyCbm", e.target.value)}
                         />
                         <TextField
                           size="small"
                           label={pricingText.freight.bulkyLdm}
                           value={activeFreight?.bulkyLdm || ""}
                           onChange={(e) => handleFreightChange("bulkyLdm", e.target.value)}
                         />
                       </Stack>
                     </Paper>
        </>
